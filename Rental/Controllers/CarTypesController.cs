...
namespace Rental.Controllers
{
    public class CarTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Make,Model,FullType,Description,Image")] CarType carType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Make,Model,FullType,Description,Image")] CarType carType)
        {
            if (id != carType.Id)
            {
                return NotFound();
